  ...
  render() {
    return (
      ...
      <div className="header">
        ...
        <button onClick={this.onClickButton} className="btn">Get Early Access</button>
        <Modal open={this.state.openModal} onClose={this.onCloseModal}>
        <div style={{padding:"10% 10%"}}>
          <h1 className="form_header" style={{fontSize:"25px"}}>BE AMONGST THE FIRST TO USE JAUNNT</h1>
          <form>
          <div>
              <p className="attributes" style={{fontSize:"15px",color:"#6C7066"}}>Full Name</p>
              <input type="text"  style={{width:"80%",padding:"6px 6px",border:"1px solid grey",borderRadius:"3px"}}/> <br />
            </div>
            <div>
              <p className="attributes" style={{fontSize:"15px",color:"#6C7066"}}>Email</p>
              <input type="email" style={{width:"80%",padding:"6px 6px",border:"1px solid grey",borderRadius:"3px"}} /> <br />
            </div>
            <div>
              <p className="attributes" style={{fontSize:"15px",color:"#6C7066"}}>Where are you located?</p>
              <select name="" id="" style={{width:"83%",padding:"6px 6px",border:"1px solid grey",borderRadius:"3px",backgroundColor:"#fff"}}>
            ...
            <div>
              <button className="form_btn" style={{width:"83%",backgroundColor:"#028F84",border:"none",padding:"13px 13px",borderRadius:"5px",color:"white"}}>Join the Early Access list</button>
            </div>
          </form>
          </div>
        </Modal>
